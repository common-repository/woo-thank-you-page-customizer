															...
															<?php if ( is_user_logged_in() && $order->get_user_id() === get_current_user_id() && $shortcodes['billing_email'] ) { ?>
                                                                <div class="<?php echo esc_attr( $data->set( array(
                                                                    ...
                                                                    <div class="<?php echo esc_attr( $data->set( array(
                                                                        ...
                                                                        <div title="<?php echo esc_attr( $shortcodes['billing_email'] ); ?>"><?php echo wp_kses_post( $shortcodes['billing_email'] ); ?></div>
                                                                    </div>
                                                                </div>
															<?php } ?>
...
//                                                                                }
                                                                            ...
                                                                            <div>
																				...
																				if ( ! $order_details_product_quantity_in_image ) {
																					echo wp_kses_post( apply_filters( 'woocommerce_order_item_quantity_html', $product_quantity_html, $item ) );
																				}
																				?>
                                                                            </div>
																			<?php
															...
															if ( $order->get_meta( 'woo_thank_you_page_coupon_code' ) ) {
																...
																switch ( $data->get_params( 'coupon_type' )[0] ) {
																	...
																	case 'unique':
																		...
																		do {
																			for ( $i = 0; $i < 6; $i ++ ) {
																				$rand        = wp_rand( 0, count( $characters_array ) - 1 );
