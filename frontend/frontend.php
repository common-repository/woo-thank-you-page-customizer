...
class VI_WOO_THANK_YOU_PAGE_Frontend_Frontend {
	...
	public function apply_layout() {
		...
		$order_id                  = isset( $_POST['order_id'] ) ? (int) sanitize_text_field( $_POST['order_id'] ) : '';// phpcs:ignore WordPress.Security.NonceVerification.Missing
		$change_url                = isset( $_POST['change_url'] ) ? sanitize_text_field( $_POST['change_url'] ) : '';// phpcs:ignore WordPress.Security.NonceVerification.Missing
		$this->payment_method_html = isset( $_POST['payment_method_html'] ) ? wp_kses_post( base64_decode( $_POST['payment_method_html'] ) ) : '';// phpcs:ignore WordPress.Security.NonceVerification.Missing
		$this->google_map_address  = isset( $_POST['google_map_address'] ) ? wp_kses_post( base64_decode( $_POST['google_map_address'] ) ) : '';// phpcs:ignore WordPress.Security.NonceVerification.Missing
                    ...
                    <div class="<?php echo esc_attr( $this->set( 'available-shortcodes-items-content' ) ) ?>">
						...
						foreach ( $this->shortcodes as $key => $value ) {
                            ...
                            <div class="<?php echo esc_attr( $this->set( 'available-shortcodes-item' ) ) ?>">
                                <div class="<?php echo esc_attr( $this->set( 'available-shortcodes-item-name' ) ) ?>"><?php echo isset( $shortcode_titles[ $key ] ) ? esc_html( $shortcode_titles[ $key ] ) : esc_html( ucwords( str_replace( '_', ' ', $key ) ) ) ?></div>
                                <div class="<?php echo esc_attr( $this->set( 'available-shortcodes-item-syntax' ) ) ?>">
                                    <input readonly value="<?php echo esc_attr( "{{$key}}" ) ?>">
	...
	public function the_content( $content ) {
		...
		if ( $order ) {
			if ( $order->has_status( 'failed' ) ) {
				ob_start();
				?>
                <p class="woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed"><?php esc_html_e( 'Unfortunately your order cannot be processed as the originating bank/merchant has declined your transaction. Please attempt your purchase again.', 'woo-thank-you-page-customizer' ); ?></p>

                <p class="woocommerce-notice woocommerce-notice--error woocommerce-thankyou-order-failed-actions">
                    <a href="<?php echo esc_url( $order->get_checkout_payment_url() ); ?>"
                       class="button pay"><?php esc_html_e( 'Pay', 'woo-thank-you-page-customizer' ) ?></a>
					<?php if ( is_user_logged_in() ) : ?>
                        <a href="<?php echo esc_url( wc_get_page_permalink( 'myaccount' ) ); ?>"
                           class="button pay"><?php esc_html_e( 'My account', 'woo-thank-you-page-customizer' ); ?></a>
					<?php endif; ?>
                </p>
				<?php
				$content = ob_get_clean();
			...
			ob_start();
			?>
            <p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo wp_kses_post( apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Thank you. Your order has been received.', 'woo-thank-you-page-customizer' ), null ) ); ?></p>
			<?php
			$content = ob_get_clean();
		}
	...
	private function social_icons_html( $icons_text ) {
        ...
        <a target="<?php echo esc_attr( $social_icons_target ); ?>" href="<?php echo esc_url( $facebook_url ) ?>"
           class="wtyp-social-button wtyp-facebook">
            <span class="wtyp-social-icon <?php echo esc_attr( $facebook_select ) ?>"></span></a>
        ...
        <a target="<?php echo esc_attr( $social_icons_target ); ?>" href="<?php echo esc_url( $twitter_url ) ?>"
           class="wtyp-social-button wtyp-twitter">
            <span class="wtyp-social-icon <?php echo esc_attr( $twitter_select ) ?>"></span>
        </a>
		<?php
        ...
        <a target="<?php echo esc_attr( $social_icons_target ); ?>" href="<?php echo esc_url( $pinterest_url ) ?>"
           ...
           data-pin-do="buttonFollow">
            <span class="wtyp-social-icon <?php echo esc_attr( $pinterest_select ) ?>"></span>
        </a>
		<?php
        ...
        <a target="<?php echo esc_attr( $social_icons_target ); ?>" href="<?php echo esc_url( $instagram_url ) ?>"
           class="wtyp-social-button wtyp-instagram">
            <span class="wtyp-social-icon <?php echo esc_attr( $instagram_select ) ?>"></span>
        </a>
		<?php
        ...
        <a target="<?php echo esc_attr( $social_icons_target ); ?>" href="<?php echo esc_url( $dribbble_url ) ?>"
           class="wtyp-social-button wtyp-dribbble">
            <span class="wtyp-social-icon <?php echo esc_attr( $dribbble_select ) ?>"></span>
        </a>
		<?php
        ...
        <a target="<?php echo esc_attr( $social_icons_target ); ?>" href="<?php echo esc_url( $tumblr_url ) ?>"
           class="wtyp-social-button wtyp-tumblr">
            <span class="wtyp-social-icon <?php echo esc_attr( $tumblr_select ) ?>"></span>
        </a>
		<?php
        ...
        <a target="<?php echo esc_attr( $social_icons_target ); ?>" href="<?php echo esc_url( $google_url ) ?>"
           class="wtyp-social-button wtyp-google-plus">
            <span class="wtyp-social-icon <?php echo esc_attr( $google_select ) ?>"></span>
        </a>
		<?php
        ...
        <a target="<?php echo esc_attr( $social_icons_target ); ?>" href="<?php echo esc_url( $vkontakte_url ) ?>"
           class="wtyp-social-button wtyp-vk">
            <span class="wtyp-social-icon <?php echo esc_attr( $vkontakte_select ) ?>"></span>
        </a>
		<?php
        ...
        <a target="<?php echo esc_attr( $social_icons_target ); ?>" href="<?php echo esc_url( $linkedin_url ) ?>"
           class="wtyp-social-button wtyp-linkedin">
            <span class="wtyp-social-icon <?php echo esc_attr( $linkedin_select ) ?>"></span>
        </a>
		<?php
        ...
        <a target="<?php echo esc_attr( $social_icons_target ); ?>" href="<?php echo esc_url( $youtube_url ) ?>"
           class="wtyp-social-button wtyp-youtube">
            <span class="wtyp-social-icon <?php echo esc_attr( $youtube_select ) ?>"></span>
        </a>
		<?php
                ...
                <div class="<?php echo esc_attr( $this->set( 'coupon-code' ) ) ?>">
                    <span class="<?php echo esc_attr( $this->set( 'coupon__code-wrap' ) ); ?> wtyp_icons-scissors">
                        <input type="text" readonly class="<?php echo esc_attr( $this->set( 'coupon__code-code' ) ); ?>"
                            ...
                            <span class="<?php echo esc_attr( $this->set( 'coupon__code-email' ) ); ?> <?php echo esc_attr( $this->get_params( 'coupon_email_enable' ) ? '' : 'woocommerce-thank-you-page-hidden' ) ?>">
            ...
            <div class="<?php echo esc_attr( $this->set( array(
                ...
                <div class="<?php echo esc_attr( $this->set( array(
                    ...
                    <div class="<?php echo esc_attr( $this->set( array(
						...
						<?php esc_html_e( 'Billing address', 'woo-thank-you-page-customizer' ); ?>
                    </div>
                    <div class="<?php echo esc_attr( $this->set( array(
						'customer_information__billing_address-address',
					) ) ) ?>">
						<?php echo wp_kses_post( $order->get_formatted_billing_address( esc_html__( 'N/A', 'woo-thank-you-page-customizer' ) ) ); ?>
				...
				if ( $show_shipping ) {
                    ...
                    <div class="<?php echo esc_attr( $this->set( array(
                        ...
                        <div class="<?php echo esc_attr( $this->set( array(
							...
							<?php esc_html_e( 'Shipping address', 'woo-thank-you-page-customizer' ); ?>
                        </div>
                        <div class="<?php echo esc_attr( $this->set( array(
							'customer_information__shipping_address-address',
						) ) ) ?>">
							<?php echo wp_kses_post( $order->get_formatted_shipping_address( esc_html__( 'N/A', 'woo-thank-you-page-customizer' ) ) ); ?>
                        </div>
                    </div>
					<?php
				}
                    ...
                    <div class="<?php echo esc_html( $this->set( array(
                        ...
                        <div class="<?php echo esc_html( $this->set( array(
                            ...
                            <div>
								...
								echo wp_kses_post( apply_filters( 'woocommerce_order_item_quantity_html', $product_quantity_html_default, $item ) );
								?>
                            </div>
							<?php
				...
				foreach ( $order->get_order_item_totals() as $key => $total ) {
                    ...
                    <div class="<?php echo esc_attr( $this->set( array(
                        ...
                        <div class="<?php echo esc_attr( $this->set( array(
							...
							if ( $key == 'order_total' ) {
								?>
                                <div><?php echo wp_kses_post( get_woocommerce_currency() ); ?></div>
								<?php
							}
							?>
			...
			if ( $order->get_customer_note() ) {
                ...
                <div class="<?php echo esc_attr( $this->set( array(
                    ...
                    <div class="<?php echo esc_attr( $this->set( array(
                        ...
                        <div><?php esc_html_e( 'Note', 'woo-thank-you-page-customizer' ); ?></div>
                    </div>
                    <div class="<?php echo esc_attr( $this->set( array(
						'order_details-value'
					) ) ) ?>">
                        <div><?php echo wp_kses_post( wptexturize( $order->get_customer_note() ) ); ?></div>
                    </div>
                </div>
				<?php
			}
			...
			<?php if ( is_user_logged_in() && $order->get_user_id() === get_current_user_id() && $order->get_billing_email() ) { ?>
                <div class="<?php echo esc_attr( $this->set( array(
                    ...
                    <div class="<?php echo esc_attr( $this->set( array(
                        ...
                        <div title="<?php echo esc_attr( $order->get_billing_email() ); ?>"><?php echo esc_html( $order->get_billing_email() ); ?></div>
                    </div>
                </div>
			<?php } ?>
